...
const Input: FC<Props<HTMLInputElement>> = ({ appendIcon, name, placeholder, label, ...props }) => {
  ...
  return (
    <div className=" min-h-[100px]">
      <div className="relative">
        ...
        <div className={` flex items-center py-2 px-3 outline-none border border-light-gray-200 rounded-[8px] h-[54px] text-[14px] w-full ${classNames}`}>
